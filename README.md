...
| **2. CLAP**                | Converts text prompt into embeddings            | Text prompt (e.g., 'Swing-style walking bass and brush drums') converted into numerical representation | N/A (CLAP operates without direct tunable parameters) |
